...
def mr_x():
    ...
    print (" ayo kelon yu")
    time.sleep(1)
    os.system("xdg-open https://youtube.com/shorts/a972guts_98?feature=share")
    time.sleep(5)
    os.system("clear")
...
def banner_anjay_subs_mr_dark():
    ...
    print ("    > Author  : Nama Kalian ")
    print ("    > YouTube : Yt Kalian ")
    print ("    > Github  : github.com/akun Github kalian ")
    print ("")
